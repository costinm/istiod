...
func (c *httpProtocol) setHost(r *http.Request, host string) {
	...
	if r.URL.Scheme == "https" {
		...
		// Commented out - tricky to compile properly. Will probably go away as 1.17 is replaced.
		//panic: qtls.Config doesn't match
		//
		//	goroutine 1 [running]:
		//	github.com/marten-seemann/qtls-go1-18.init.0()
		//	/usr/local/google/home/costin/go/pkg/mod/github.com/marten-seemann/qtls-go1-18@v0.1.0-beta.1/unsafe.go:20 +0x4ce
