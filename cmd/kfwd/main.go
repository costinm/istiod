...
// From: https://raw.githubusercontent.com/gianarb/kube-port-forward/master/main.go
...
func main() {
	...
	//config, err := clientcmd.BuildConfigFromFlags("http://127.0.0.1:8001", "")//*kubeconfig)
	//if err != nil {
	//	panic(err.Error())
	//}

	// Use with kubectl proxy -
	config := &rest.Config{
